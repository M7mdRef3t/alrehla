...
import { Eye, ChevronRight, X, Sparkles, Brain } from "lucide-react";
...
export const ShadowInsightPanel: FC<{ onSurface?: (context: any) => void }> = ({ onSurface }) => {
    ...
    const acknowledge = async (action: 'explore' | 'ignore') => {
        ...
        try {
            ...
            if (action === 'explore') {
                ...
                console.log("Exploring Shadow:", signal.target_id);
            }
        } catch (err) {
