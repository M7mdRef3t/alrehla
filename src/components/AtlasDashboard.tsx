                ...
                <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={1}>
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      labelFormatter={(_label: unknown, payload: unknown[] | undefined) =>
                        ((payload?.[0] as { payload?: { pathLabel?: string } })?.payload?.pathLabel)
                          ? `${((payload[0] as { payload?: { pathLabel?: string } }).payload?.pathLabel)} — بدايات: ${((payload[0] as { payload?: { starts?: number } }).payload?.starts)}`
                          : ""
                      }
                    />
              ...
              <div className="h-56">
                <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={1}>
                  ...
                  >
                    ...
                    <YAxis fontSize={11} />
                    <Tooltip
                      labelFormatter={(_label: unknown, payload: unknown[] | undefined) => ((payload?.[0] as { payload?: { date?: string } })?.payload?.date) ?? ""}
                    />
                    <Legend />
                    <Line
                      type="monotone"
