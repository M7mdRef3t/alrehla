                ...
                <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={1}>
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      labelFormatter={(_label: unknown, payload: readonly unknown[] | undefined) =>
              ...
              <div className="h-56">
                <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={1}>
                  ...
                  >
                    ...
                    <YAxis fontSize={11} />
                    <Tooltip
                      labelFormatter={(_label: unknown, payload: readonly unknown[] | undefined) => payload?.[0]?.payload?.date ?? ""}
                    />
                    <Legend />
                    <Line
                      type="monotone"
