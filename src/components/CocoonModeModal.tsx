    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-md rounded-3xl bg-slate-900 text-white p-6 shadow-2xl text-center space-y-4"
        >
          <div className="flex items-center justify-center gap-2 text-slate-200">
            <Moon className="w-5 h-5" />
            <span className="text-sm font-semibold">وضع الشرنقة</span>
          </div>
