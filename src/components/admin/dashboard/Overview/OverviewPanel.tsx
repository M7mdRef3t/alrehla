...
export const OverviewPanel: FC = () => {
  ...
  const successDecisionLabel = successDecision === "scale" ? "المهمة واضحة: نشر التوسع" : successDecision === "optimize" ? "تحسين المسار: مطلوب تحسين" : successDecision === "pivot" ? "فشل الفرضية: محوري حرج" : "قياس غير كاف";
