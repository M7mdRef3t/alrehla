...
export const RevenueEngineCard: FC<RevenueEngineCardProps> = ({
  ...
  return (
    <CollapsibleSection title="مفاعلات التدفق (Revenue Engine)" icon={<ActivitySquare className="w-5 h-5 text-emerald-400" />} headerColors="border-indigo-500/10 bg-slate-900/40 text-slate-300" defaultExpanded={false}>
