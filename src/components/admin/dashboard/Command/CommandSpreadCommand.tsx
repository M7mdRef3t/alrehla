...
interface CommandSpreadCommandProps {
  minimal?: boolean;
}

export const CommandSpreadCommand: FC<CommandSpreadCommandProps> = ({ minimal }) => {
  ...
  useEffect(() => {
    const fetchMetrics = async () => {
      try {
        ...
        console.warn("[CommandSpreadCommand] fetchMetrics error", err);
      }
    };
    fetchMetrics();
