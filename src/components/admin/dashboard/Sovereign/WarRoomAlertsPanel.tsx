...
export const WarRoomAlertsPanel: FC = () => {
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-rose-500/60 text-[10px] font-black uppercase tracking-widest">Active System Incidents</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          {activeIncidents.length > 0 && (
            <button 
              ...
              className="px-4 py-2 bg-rose-500/10 border border-rose-500/30 rounded-xl text-[10px] font-black text-rose-500 hover:text-white hover:bg-rose-500 transition-all uppercase tracking-widest flex items-center gap-2 disabled:opacity-50"
            >
