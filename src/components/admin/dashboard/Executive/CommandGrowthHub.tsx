...
const CommandExpansionHub = lazy(() => import("./CommandExpansionHub").then(m => ({ default: m.CommandExpansionHub })));
...
const CommandFunnel = lazy(() => import("../Analytics/CommandFunnel").then(m => ({ default: m.CommandFunnel })));
...
export const CommandGrowthHub: FC = () => {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-black text-white tracking-tight">
                  محرك التوسع والنمو القيادي
                </h2>
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">
                  Command Growth Engine · Expansion Hub
                </p>
              </div>
            </div>
          </div>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Suspense fallback={<AwarenessSkeleton />}>
            {activeTab === "strategy"  && <CommandExpansionHub />}
            {activeTab === "stories"   && <StoriesPanel />}
            {activeTab === "marketing" && <MarketingOpsPanel />}
            {activeTab === "funnel"    && <CommandFunnel />}
          </Suspense>
        </motion.div>
      </AnimatePresence>
    </div>
