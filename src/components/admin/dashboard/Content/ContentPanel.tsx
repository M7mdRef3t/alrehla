...
export const ContentPanel: FC = () => {
    ...
    const [missionTrack, setMissionTrack] = useState("Root Path");
    ...
    const loadContentEntries = useCallback(async () => {
        ...
        try {
            ...
            if (!data) {
                setContentStatus("Failed to load platform texts.");
                return;
            }
        ...
        <div className="space-y-6 text-slate-200" dir="rtl">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 bg-slate-950/40 backdrop-blur-3xl rounded-3xl border border-white/5 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-2xl font-black text-white tracking-tight">Content Management</h3>
                ...
                <div className="relative z-10 flex p-1 bg-slate-900/50 rounded-xl border border-white/5 overflow-x-auto">
                    {([
                        { id: "cms", label: "Platform Texts", icon: <FileText className="w-4 h-4" /> },
                        { id: "simulation", label: "Results Simulation", icon: <Cpu className="w-4 h-4" /> },
                        { id: "missions", label: "Missions", icon: <ListTodo className="w-4 h-4" /> },
                        { id: "broadcasts", label: "Live Broadcast", icon: <Radio className="w-4 h-4" /> }
                    ] as const).map((tab) => (
                        <button
                            key={tab.id}
                    ...
                    >
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1 relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="Search in keys or content..."
                        ...
                        <div className="admin-glass-card p-5 border-dashed border-slate-700 bg-slate-900/20">
                            <div className="flex items-center gap-2 mb-4 text-slate-400">
                                ...
                                <span className="text-xs font-bold">Add New Text</span>
                            </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {filteredContentEntries.length === 0 ? (
                                <div className="text-center py-10 text-slate-500">No matching results found</div>
                    ...
                    >
                        <div className="lg:col-span-1 space-y-6">
                            <div className="admin-glass-card p-5">
                                <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2"><Cpu className="w-4 h-4" /> Simulation Inputs</h3>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <label className="text-xs text-slate-400 mb-1.5 block">Security Question</label>
                                    ...
                                    <label className="flex items-center gap-3 p-3 bg-rose-500/10 border border-rose-500/20 rounded-lg cursor-pointer">
                                        ...
                                        <span className="text-xs font-bold text-rose-400">Extreme Emergency State (Override)</span>
                                    </label>
                                </div>
                            </div>

                            <div className="admin-glass-card p-5">
                                <h3 className="text-sm font-bold text-white mb-4">Emotion Answers</h3>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div className="admin-glass-card p-6 border-indigo-500/20 bg-indigo-500/5">
                                <h3 className="text-sm font-bold text-indigo-300 mb-6">Expected Result (Preview)</h3>
                ...
                {activeTab === "missions" && (
                    <motion.div key="missions" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                        <div className="admin-glass-card p-5 border-l-4 border-l-purple-500">
                            <h3 className="text-sm font-bold text-white mb-4">Add New Mission</h3>
                            <div className="flex gap-4 items-end">
                                ...
                                <div className="w-32">
                                    ...
                                    <select value={missionTrack} onChange={e => setMissionTrack(e.target.value)} className="w-full bg-slate-950 border border-slate-800 rounded-lg px-2 py-2 text-xs text-white">
                                        <option>Root Path</option>
                                        <option>Relations Path</option>
                                    </select>
                                </div>
                                <button onClick={handleAddMission} className="px-6 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg text-xs font-bold transition-colors">Add</button>
                            </div>
                        </div>
                    ...
                    <motion.div key="broadcasts" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                        <div className="admin-glass-card p-5 border-l-4 border-l-amber-500 bg-amber-500/5">
                            <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
                                ...
                                Send Live Broadcast (Emergency Broadcast)
                            </h3>
                            <div className="space-y-3">
                                <input value={broadcastTitle} onChange={e => setBroadcastTitle(e.target.value)} placeholder="Message Title" className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-xs text-white" />
                                <textarea value={broadcastBody} onChange={e => setBroadcastBody(e.target.value)} placeholder="Message text..." rows={3} className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-xs text-white resize-none" />
