            ...
            <div className="flex items-start gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-semibold rounded-full px-2 py-0.5 border border-emerald-200 bg-white/80 text-emerald-800 dark:border-emerald-900/60 dark:bg-slate-950/60 dark:text-emerald-200">
                    {source === "ai" ? "AI" : "قالب"}
                  </span>
                </div>
