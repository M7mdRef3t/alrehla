...
export class RecoveryEngine {
    ...
    static async generateRecoveryPath(insight: MirrorInsight): Promise<RecoveryPath | null> {
        const prompt = `
            بصفتك System Architect و خبير نفسي لمنصة "الرحلة". 
            ...
            ◈ المحور الرأسي: كل تناقض نفسي أفقي = عرض محتمل لانقطاع رأسي (ضعف اتصال بالمصدر/ربنا).
            البشر "مرايات" مش مصادر طاقة. لو الخطورة عالية، اجعل أول مهمة تتضمن لحظة صمت/تنفس/اتصال بالمصدر.
            استخدم: "ربنا"، "المصدر"، "السلام الداخلي". تجنب: "الدين"، "العبادة".
            ...
            1. pressure_release: مهمة سهلة جداً لتقليل القلق وفتح المجال للتفكير (ممكن تبدأ بلحظة صمت أو تنفس أو امتنان).
            2. mirror_flash: مهمة تواجه المستخدم بالتناقض بشكل مباشر وسريع.
            3. resolve: مهمة لاتخاذ قرار فعلي على خريطة "الرحلة" (نقل عقدة، أرشفتها، أو تعديل مكانها).
