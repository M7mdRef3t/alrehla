...
const CHRONICLE_TEMPLATES = [
    "الليلة التي استعاد فيها {rank} سيطرته على مداراته. لم يكن مجرد صعود، بل كان إعلاناً للقيادة.",
    ...
    "في قلب العاصفة، وجد {rank} ملاذه. اليوم، القيادة ليست مجرد كلمة، بل واقع يعيشه."
];
