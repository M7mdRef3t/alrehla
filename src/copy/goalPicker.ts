export const goalPickerCopy = {
  ...
  options: [
    ...
    { id: "friends", label: "الأصدقاء", subtitle: "مين بيشحنك ومين بيسحبك في الدايرة القريبة." },
    { id: "work", label: "الشغل", subtitle: "مدير، زميل، عميل… مين واخد من طاقتك أكتر ما يستاهل." },
    ...
    { id: "self", label: "أنا ونفسي", subtitle: "علاقتك مع نفسك… التحليل الزيادة والإرهاق الداخلي." },
