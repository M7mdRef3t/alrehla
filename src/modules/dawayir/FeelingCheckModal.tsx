  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-8 pt-10">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-teal-500/10 border border-teal-500/20 flex items-center justify-center">
                <currentQ.icon className="w-5 h-5 text-teal-400" />
              </div>
              <span className="text-sm font-black text-teal-500 uppercase tracking-widest">{currentQ.label}</span>
            </div>
            ...
            >
              ...
              <div className="space-y-6">
                <input 
                  ...
                  className="w-full h-2 bg-white/5 rounded-full appearance-none cursor-pointer accent-teal-500 slider-thumb-premium"
                />
                
                <div className="flex justify-between text-xs font-bold tracking-wide">
                  <span className="text-rose-400/70">{currentQ.lowLabel}</span>
                  <span className="text-teal-400/70">{currentQ.highLabel}</span>
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
          ...
          <div className="flex gap-4 mt-12">
            {step > 0 && (
              <button
                onClick={handleBack}
                className="flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl border border-white/5 text-slate-400 hover:bg-white/5 transition-all text-sm font-bold"
              >
            ...
            <button
              onClick={handleNext}
              className="flex-[2] flex items-center justify-center gap-2 py-4 rounded-2xl bg-teal-500 text-slate-950 hover:bg-teal-400 transition-all text-sm font-black shadow-lg shadow-teal-500/20"
            >
        ...
        {/* Footer info */}
        <div className="bg-slate-950/50 p-6 flex items-center gap-3 border-t border-white/5">
