...
export const GamificationNudgeToast: FC = () => {
  ...
  useEffect(() => {
    const handler = (nudge: NudgeData) => {
      // Suppress nudges during critical onboarding/diagnostic flows
      const isAddPersonOpen = typeof document !== "undefined" && document.getElementById('add-person-title') !== null;
      if (isAddPersonOpen) return;
