...
export const LevelBanner = () => {
    ...
    return (
        ...
        >
            {/* Background elements */}
            <div className="absolute -top-10 -right-10 w-32 h-32 bg-[var(--soft-teal)]/10 rounded-full blur-3xl" />
            ...
            <div className="relative flex items-center justify-between gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="w-full h-2 bg-slate-900/50 rounded-full border border-white/5 overflow-hidden">
                        <motion.div
                            className="h-full bg-gradient-to-r from-[var(--soft-teal)] via-purple-500 to-[var(--soft-teal)] shadow-[0_0_10px_rgba(99,102,241,0.5)]"
                            initial={{ width: 0 }}
