/**
 * Leadership Profile — ملف الرحلة الخاص 🛡️
 * ==========================================
 * تعرض رتبة المستخدم وتقدمه في نقاط الخبرة.
 */
...
export const LeadershipProfile: React.FC = () => {
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-[10px] font-bold text-slate-500">مستوى {level}</span>
                        </div>
                ...
                {transformationDiagnosis?.state && (
                    <div className="pt-2 border-t border-white/5">
                         <div className="flex items-center justify-between">
                            <span className="text-[9px] font-bold text-slate-500 uppercase tracking-tighter">الحالة الحالية</span>
