...
export const TheArmoryScreen: FC<TheArmoryScreenProps> = ({
    ...
    const systems: ProtectiveSystem[] = [
        ...
        },
        {
            ...
            description: "إغلاق مؤقت وتجميد لكافة المدخلات للسماح للنظام بإعادة التشغيل (Hard Reset) بعد الصدمات.",
            status: "standby",
            icon: Waves,
        ...
        {
            id: "mirror",
            name: "وظيفة المرآة (Mirror Protocol)",
            description: "مواجهة الافتراضات الشعورية الصادمة قبل أن تتحول لردود فعل تلقائية مدمّرة.",
            status: "standby",
            icon: Eye,
            colorClass: "text-rose-400",
            bgClass: "bg-rose-500/10 border-rose-500/30",
            actionLabel: "كشف الافتراض",
        ...
        },
        {
            ...
            description: "تسجيل تاريخي لكل القناعات والتجارب، مشفر وغير قابل للتلاعب، لرؤية التسلسل الزمني للتطور.",
            status: "standby",
            icon: Database,
        ...
        {
            id: "time",
            name: "خزنة الزمن (Time Vault)",
            description: "رسائل مسجلة منك لنفسك في المستقبل، لا تفتح إلا عند انطباق شروط شعورية محددة.",
            status: "locked",
            icon: History,
            colorClass: "text-slate-400",
            bgClass: "bg-slate-500/10 border-slate-500/30",
            actionLabel: "قيد التطوير",
