                ...
                >
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-white/5 bg-slate-800/50">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-bold text-slate-100 font-tajawal">مساعد وضع الحدود (رسائل جاهزة)</h3>
                        </div>
                    ...
                    <div className="p-5">
                        <p className="text-sm text-slate-300 mb-4 leading-relaxed font-tajawal">
                            الذكاء الاصطناعي هيكتبلك رسالة جاهزة تقدر تبعتها لـ <strong className="text-white">{node.label}</strong> عشان تعتذر أو تحط حدود ذكية توقف استنزاف طاقتك، من غير ما تعمل مشكلة كبيرة.
                        </p>
