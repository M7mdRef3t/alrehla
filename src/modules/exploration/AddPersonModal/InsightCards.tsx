  ...
  return (
    <div className="grid grid-cols-1 gap-6">
      ...
      >
        ...
        <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-blue-500/10 rounded-tr-xl" />
        <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-blue-500/10 rounded-bl-xl" />

        <h3 className="text-[10px] font-black text-blue-400 mb-6 flex items-center gap-3 font-tajawal">
          <span className="w-2 h-2 rounded-full bg-blue-500" /> {result.understanding_title}
        </h3>
      ...
      >
        {/* Subtle corner accents */}
        <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-violet-500/10 rounded-tr-xl" />
        <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-violet-500/10 rounded-bl-xl" />

        <h3 className="text-[10px] font-black text-violet-400 mb-6 flex items-center gap-3 font-tajawal">
          <span className="w-2 h-2 rounded-full bg-violet-500" /> {result.explanation_title}
        </h3>
      ...
      >
        ...
        <h3 className="text-[10px] font-black text-indigo-400 mb-4 flex items-center gap-3 font-tajawal">
        ...
        >
          ...
          <span className="font-tajawal">الموسوعة: جمل جاهزة للرد على {displayName}</span>
