...
import type { CommandSnapshot } from "@/utils/commandSnapshot";

interface CommandSnapshotCardProps {
  snapshot: CommandSnapshot;
}

const toneTokens: Record<
  CommandSnapshot["tone"],
...
export const CommandSnapshotCard: FC<CommandSnapshotCardProps> = ({ snapshot }) => {
