    ...
    return (
        <div className="w-full max-w-[38rem] mx-auto mt-6">
            <button
                ...
                className="w-full flex items-center justify-between p-4 rounded-2xl bg-slate-900/40 border border-white/5 hover:bg-slate-900/60 transition-all border-l-cyan-500/50 border-l-4 group"
            >
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-right">
                        <p className="text-sm font-black text-white">الأنماط العميقة (Deep Patterns)</p>
                        <p className="text-[10px] text-slate-500">تحليل العلاقات الخفية بين دواير حياتك</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-4 px-2 pb-6">
                            {insights.map((insight) => (
                                <motion.div
                                    ...
                                    className="p-5 rounded-3xl bg-white/[0.03] border border-white/10 relative overflow-hidden group/item"
                                >
