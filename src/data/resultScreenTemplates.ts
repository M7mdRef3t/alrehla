...
export const RESULT_SCREEN_SCENARIOS = {
  emergency: {
    ...
    obstacles: [
      {
        title: "شلل الخوف",
        solution: "الذكاء الاصطناعي هنا دوره يوصلك بمتخصص فوراً."
      }
    ],
    understanding_body:
    ...
    suggested_zone_label: "بروتوكول الحماية (SOS)",
    suggested_zone_body:
      "لو تقدر، فعّل خطة أمان: تواصل مع شخص موثوق، وخد خطوات خروج آمنة، ولو في خطر مباشر اطلب نجدة."
  },
  emotional_prisoner: {
    title: "استنزاف عن بُعد",
    state_label: "سجين ذهني",
    goal_label: "كسر السلاسل / إسكات الضجيج",
    promise_label: "استرداد المساحة العقلية",
    promise_body:
      "دماغك هيرجع ملكك تاني.. مفيش محاكمات وهمية، مفيش ذنب، وصوتك الداخلي هو اللي هيمشي.",
    mission_label: "مهمة التحرير",
    mission_goal: "استرداد المساحة العقلية",
    requirements: [
      { title: "ملف القضية الحقيقي", detail: "ورقة مكتوب فيها \"ليه بعدت عنهم؟\" (تستخدم كمصل ضد الحنين)." },
      { title: "بديل الدوبامين", detail: "نشاط ممتع جاهز فوراً لما الفكرة تهاجمك." }
    ],
    steps: [
      "غمامة العزل: إخفاء (Mute/Block) لمدة 7 أيام.",
      "كاتم الصوت: كل ما تلاقي محاكمة شغالة في دماغك، قول بصوت عالي \"مش هنا.. مش دلوقتي.. ومش أنا اللي هحلها\" وغير مكانك.",
      "حرق الرسائل: اكتب كل اللي عايز تقوله في ورقة وقطعها (تفريغ من غير إرسال)."
    ],
    obstacles: [
      {
        title: "فخ الذكريات الوردية",
        solution: "اقرأ \"ملف القضية الحقيقي\" فوراً."
      }
    ],
    understanding_body:
  ...
  eggshells: {
    ...
    steps: [
      "رسمية التعامل: حول العلاقة لـ \"تعامل رسمي\" (صباح الخير / أخبار الشغل إيه / تمام).",
