...
> = {
  red: {
    ...
    unselected: "bg-app-muted text-app-muted-foreground border-2 border-transparent",
    unselectedHover: "hover:bg-rose-500/10 hover:border-rose-500/20 hover:text-rose-600 dark:hover:text-rose-400"
  },
  amber: {
    selected: "bg-amber-500 text-white border-2 border-amber-600 shadow-[0_0_15px_rgba(245,158,11,0.3)]",
    unselected: "bg-app-muted text-app-muted-foreground border-2 border-transparent",
    unselectedHover: "hover:bg-amber-500/10 hover:border-amber-500/20 hover:text-amber-600 dark:hover:text-amber-400"
  },
  yellow: {
    selected: "bg-yellow-400 text-teal-950 border-2 border-yellow-500 shadow-[0_0_15px_rgba(250,204,21,0.3)]",
    unselected: "bg-app-muted text-app-muted-foreground border-2 border-transparent",
    unselectedHover: "hover:bg-yellow-400/10 hover:border-yellow-400/20 hover:text-yellow-600 dark:hover:text-yellow-400"
  },
  green: {
    selected: "bg-teal-500 text-white border-2 border-teal-600 shadow-[0_0_15px_rgba(20,184,166,0.3)]",
    unselected: "bg-app-muted text-app-muted-foreground border-2 border-transparent",
    unselectedHover: "hover:bg-teal-500/10 hover:border-teal-500/20 hover:text-teal-600 dark:hover:text-teal-400"
  }
};
...
export function getOptionButtonClass(tier: OptionTier, isSelected: boolean): string {
  ...
  return `${base} ${t.unselected} ${t.unselectedHover} focus-visible:ring-teal-400/50`;
}
