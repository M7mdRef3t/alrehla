...
type NextPublicKey =
  ...
  | "NEXT_PUBLIC_ENABLE_META_EVENTS"
...
function readNextPublicStatic(key: NextPublicKey): string | undefined {
  const candidates: Record<NextPublicKey, string | undefined> = {
    ...
    NEXT_PUBLIC_ENABLE_META_EVENTS: process.env.NEXT_PUBLIC_ENABLE_META_EVENTS,
...
export const runtimeEnv = {
  ...
  enableMetaEvents: readEnv("VITE_ENABLE_META_EVENTS") === "true",
  ...
  julesApiKey: readServerOnlyEnv("JULES_API_KEY"),
  ...
  dawayirLiveApiKey: readServerOnlyEnv("DAWAYIR_LIVE_API_KEY"),
