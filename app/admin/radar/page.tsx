          ...
          <section className="grid gap-4 md:grid-cols-3">
            ...
            <article className="rounded-2xl border border-[var(--vibrant-blue)]/20 bg-[var(--vibrant-blue)]/5 p-5 md:col-span-3">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <a
                  href="https://www.tiktok.com/v2/auth/authorize/?client_key=aweisl8l27wg7vyj&response_type=code&scope=user.info.basic,video.list&redirect_uri=https://www.alrehla.app/api/tiktok/callback&state=demo"
